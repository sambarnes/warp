...
func abi_encode_bool_to_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    alloc_locals
    let (local _1_4 : Uint256) = is_zero(value)
    local range_check_ptr = range_check_ptr
    let (local _2_5 : Uint256) = is_zero(_1_4)
    local range_check_ptr = range_check_ptr
...
func abi_encode_bool{memory_dict : DictAccess*, msize, range_check_ptr}(
    ...
    local range_check_ptr = range_check_ptr
    abi_encode_bool_to_bool(value0, headStart_6)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
    return (tail)
...
func __warp_block_1{
    ...
    local range_check_ptr = range_check_ptr
    local _17 : Uint256 = Uint256(low=1, high=0)
    local _18 : Uint256 = _1
    let (local _19 : Uint256) = abi_encode_bool(_1, _17)
    local memory_dict : DictAccess* = memory_dict
    local msize = msize
    local range_check_ptr = range_check_ptr
...
func __warp_block_0{
    ...
    local range_check_ptr = range_check_ptr
    local _11 : Uint256 = Uint256(low=1266346486, high=0)
