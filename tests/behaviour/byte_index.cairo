...
func abi_encode_uint256{memory_dict : DictAccess*, msize, range_check_ptr}(headStart : Uint256) -> (
        tail : Uint256):
    alloc_locals
    let (tail : Uint256) = u256_add(headStart, Uint256(low=32, high=0))
    uint256_mstore(offset=headStart, value=Uint256(low=0, high=0))
    return (tail)
end
...
func __warp_block_3{
    ...
    uint256_mstore(offset=Uint256(low=64, high=0), value=Uint256(low=224, high=0))
    uint256_mstore(offset=Uint256(low=128, high=0), value=Uint256(low=51, high=0))
    uint256_mstore(
        offset=Uint256(low=160, high=0),
        value=Uint256(low=340282366920938463463374607431768211455, high=340282366920938463463374607431768211455))
    uint256_mstore(
        offset=Uint256(low=192, high=0),
        value=Uint256(low=340282346638528859811704183484516925440, high=340282366920938463463374607431768211455))
    uint256_mstore(offset=Uint256(low=224, high=0), value=Uint256(low=0, high=0))
    warp_return(Uint256(low=224, high=0), Uint256(low=32, high=0))
    return ()
end
...
func __warp_block_5{
    ...
    let (__warp_subexpr_4 : Uint256) = abi_encode_uint256(memPos)
...
func __warp_block_4{
    ...
    alloc_locals
    let (__warp_subexpr_0 : Uint256) = is_eq(match_var, Uint256(low=3793197966, high=0))
...
func __warp_block_2{
        ...
        msize, range_check_ptr, termination_token}(match_var : Uint256) -> ():
    alloc_locals
    let (__warp_subexpr_0 : Uint256) = is_eq(match_var, Uint256(low=638722032, high=0))
